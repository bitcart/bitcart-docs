...
[Setup Guide](https://appriseit.com/services/telegram). However, there are few recommendations and
gotchas.
...
notes, and shipping addresses. Bitcart provides a ready filter for markdown v1, e.g. `{{ invoice.buyer_email|tg_escape }}`.

But if you're doing anything but the simplest of reports, it's *highly* recommended to just switch HTML templates
over Markdown.
